...
public class WriteInputToFile {
	...
	private static final String ADL = "org.inria.scale.streams.examples.WriteInputToFile";
	...
	public static void main(final String... args) throws Exception {
		try {
			...
			final ProActiveDescriptor deploymentDescriptor = //
					PADeployment.getProactiveDescriptor(WriteInputToFile.class.getClassLoader().getResource("deployment.xml")
							.getPath());
