...
public class InputWordCountStreaming {
	...
	private static final String ADL = "org.inria.scale.streams.examples.InputWordCountStreaming";
	...
	public static void main(final String... args) throws Exception {
		try {
			...
			final ProActiveDescriptor deploymentDescriptor = //
					PADeployment.getProactiveDescriptor(InputWordCountStreaming.class.getClassLoader().getResource("deployment.xml")
							.getPath());
