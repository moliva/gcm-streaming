...
public class TwoWordCountStreaming {

	private static final String ADL = "org.inria.scale.streams.examples.TwoWordCountStreaming";
	...
	public static void main(final String... args) throws Exception {
		try {
			...
			final ProActiveDescriptor deploymentDescriptor = //
					PADeployment.getProactiveDescriptor(TwoWordCountStreaming.class.getClassLoader().getResource("deployment.xml")
							.getPath());
